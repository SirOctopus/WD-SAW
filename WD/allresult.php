...
$query = $mysqli->query("SELECT * FROM autista JOIN utenti ON autista.email = utenti.email");
...
?>
 ...
 <div class="footer">
    ...
    <ul id="menu">
      ...
      <li class="active"><a href="allresult.php"><i class="material-icons">import_contacts</i></a></li>
